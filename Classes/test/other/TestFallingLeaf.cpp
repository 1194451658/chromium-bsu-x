...
bool TestFallingLeaf::init()
{
	...
	// init
	CCSpriteExt *spriteLeaf1 = CCSpriteExt::create("test/testFallingLeaf1.jpg");  
	...
	CCSpriteExt *spriteLeaf2 = CCSpriteExt::create("test/testFallingLeaf1.jpg");  
...
void TestFallingLeaf::playLeafAnim(CCSpriteExt *spriteLeaf)  
{  
...
{  
	...
	//重新生成新的叶片，在起点处释放  
	CCSpriteExt *spriteLeaf = CCSpriteExt::create(sImg);  
